...
def ingresarValoresTeclado(evento):
    tecla = evento.char
    print(evento)
...
button_borrar=ttk.Button(mainframe,text=chr(9003),style="Botones_borrar.TButton",command=lambda: borrar()) #chr(9003) es un caracter
...
root.bind('<Key>',ingresarValores)
root.bind('<KeyPress-b>',borrar)    
root.bind("<KeyPress-\r>",ingresarValoresTeclado)  
root.mainloop()
